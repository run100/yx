...
{
    title: "踏青庐江，斗茶品茗！为你喜欢的庐江茶企投上宝贵的一票！",
    desc: "5月27日，中国（安徽）第十届国际茶产业博览会，在安徽国际会展中心统一颁奖！",
    link: "http://ljcwhlyj.365jia.cn/dcpm",
    imgUrl: "http://365jia.cn/css/zt/2016/dcpm/images/share.jpg",
    success: function() {
        //分享成功,可加统计逻辑
    },
    cancel: function() {
...
@section('pages')
                ...
                <ul>
                    <li>
                        <div class="weui-flex js_category">
                            ...
                            <img src="/vendor/zhuanti/weui/dist/pages/images/icon_nav_form.png" alt="">
                        </div>
                    ...
                    <li>
                        <div class="weui-flex js_category">
                            ...
                            <img src="/vendor/zhuanti/weui/dist/pages/images/icon_nav_layout.png" alt="">
                        </div>
                        <div class="page__category js_categoryInner">
                            <div class="weui-cells page__category-content">
                    ...
                    <li>
                        <div class="weui-flex js_category">
                            ...
                            <img src="/vendor/zhuanti/weui/dist/pages/images/icon_nav_feedback.png" alt="">
                        </div>
                        <div class="page__category js_categoryInner">
                            <div class="weui-cells page__category-content">
                    ...
                    <li>
                        <div class="weui-flex js_category">
                            ...
                            <img src="/vendor/zhuanti/weui/dist/pages/images/icon_nav_nav.png" alt="">
                        </div>
                        <div class="page__category js_categoryInner">
                            <div class="weui-cells page__category-content">
                    ...
                    <li>
                        <div class="weui-flex js_category">
                            ...
                            <img src="/vendor/zhuanti/weui/dist/pages/images/icon_nav_search.png" alt="">
                        </div>
                        <div class="page__category js_categoryInner">
                            <div class="weui-cells page__category-content">
    ...
    <template id="tpl_button" title="按钮">
        <div class="page">
            <div class="page__hd">
            ...
            <div class="page__ft">
                <a href="javascript:home()"><img src="/vendor/zhuanti/weui/dist/pages/images/icon_footer_link.png" /></a>
            </div>
        </div>
    </template>
    <template id="tpl_list" title="列表">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_input" title="表单输入">
        <div class="page">
            <div class="page__hd">
            ...
            <div class="page__bd">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell weui-cell_vcode">
                        ...
                        <div class="weui-cell__ft">
                            <img class="weui-vcode-img" src="/vendor/zhuanti/weui/dist/pages/images/vcode.jpg" />
                        </div>
                    </div>
                </div>
    ...
    <template id="tpl_toast" title="弹出提示">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_dialog" title="对话框">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_progress" title="进度条">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_msg_success" title="操作成功">
        <div class="page">
            <div class="weui-msg">
    ...
    <template id="tpl_msg_warn" title="操作失败">
        <div class="page">
            <div class="weui-msg">
    ...
    <template id="tpl_article" title="文章">
        <div class="page">
            <div class="page__hd">
                ...
                <article class="weui-article">
                    ...
                    <section>
                        ...
                        <section>
                            ...
                            <p>
                                <img src="/vendor/zhuanti/weui/dist/pages/images/pic_article.png" alt="">
                                <img src="/vendor/zhuanti/weui/dist/pages/images/pic_article.png" alt="">
                            </p>
                        </section>
                        <section>
    ...
    <template id="tpl_navbar" title="导航TAB">
        <div class="page">
    ...
    <template id="tpl_tabbar" title="底部导航">
        <div class="page">
            <div class="page__bd" style="height: 100%;">
                <div class="weui-tab">
                    <div class="weui-tab__panel">
    ...
    <img src="/vendor/zhuanti/weui/dist/pages/images/icon_tabbar.png" alt="" class="weui-tabbar__icon">
    ...
    <template id="tpl_panel" title="面板">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_actionsheet" title="弹出菜单">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_icons" title="图标">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_searchbar" title="搜索栏">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_picker" title="选择器">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_footer" title="页脚">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_gallery" title="画廊">
        <div class="page">
            <div class="page__hd">
            ...
            <div class="weui-gallery" style="display: block">
                <span class="weui-gallery__img" style="background-image: url(/vendor/zhuanti/weui/dist/pages/images/pic_article.png);"></span>
    ...
    <template id="tpl_flex" title="Flex 布局">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_loadmore" title="滚动加载">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_layers" title="WeUI 页面层级">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_uploader" title="上传组件">
        <div class="page">
            <div class="page__hd">
                            ...
                            <div class="weui-uploader">
                                ...
                                <div class="weui-uploader__bd">
                                    <ul class="weui-uploader__files" id="uploaderFiles">
                                        <li class="weui-uploader__file" style="background-image:url(/vendor/zhuanti/weui/dist/pages/images/pic_160.png)"></li>
                                        <li class="weui-uploader__file" style="background-image:url(/vendor/zhuanti/weui/dist/pages/images/pic_160.png)"></li>
                                        <li class="weui-uploader__file" style="background-image:url(/vendor/zhuanti/weui/dist/pages/images/pic_160.png)"></li>
                                        <li class="weui-uploader__file weui-uploader__file_status" style="background-image:url(/vendor/zhuanti/weui/dist/pages/images/pic_160.png)">
    ...
    <template id="tpl_preview" title="表单预览">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_grid" title="九宫格">
        <div class="page">
            <div class="page__hd">
            ...
            <div class="weui-grids">
                <a href="javascript:;" class="weui-grid">
                    <div class="weui-grid__icon">
                        <img src="/vendor/zhuanti/weui/dist/pages/images/icon_tabbar.png" alt="">
                    </div>
    ...
    <template id="tpl_badge" title="徽章">
        <div class="page">
            <div class="page__hd">
    ...
    <template id="tpl_slider" title="滑块">
        <div class="page">
            <div class="page__hd">
