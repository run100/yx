...
<head>
    ...
    <script src="{{ admin_asset ("/vendor/zhuanti/jquery-deserialize/dist/jquery.deserialize.min.js") }}"></script>
    <script src="{{ admin_asset ("/js/jquery.ba-serializeobject.min.js") }}"></script>
    <script src="{{ admin_asset ("/vendor/laravel-admin/ueditor/ueditor.config.js") }}"></script>
    <!--[if lt IE 9]>
...
<script src="{{ admin_asset ("/vendor/zhuanti/sweetalert/dist/sweetalert.min.js") }}"></script>
{!! Admin::js() !!}
