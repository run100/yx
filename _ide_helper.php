 ...
 * Generated for Laravel 5.5.37 on 2018-03-26 12:08:35.
 *
...
namespace App\MicroServs\Facades { 
    ...
    class MicroServs {
         ...
         * @static 
         */ 
        public static function getClientInst($name)
        {
            return \App\MicroServs\Helper::getClientInst($name);
        }
         ...
         * @static 
         */ 
        public static function concurrent($process, $wait = true)
        {
            return \App\MicroServs\Helper::concurrent($process, $wait);
        }
...
namespace Encore\Admin\Facades { 
    ...
    class Admin {
        ...
        {
            return \Encore\Admin\Admin::userRole();
        }
...
namespace  { 
    ...
    class MicroServs extends \App\MicroServs\Facades\MicroServs {}
